...
public class AlloyerOutputSlot extends Slot {
    private final PlayerEntity player;
    private int removeCount;

    public AlloyerOutputSlot(PlayerEntity player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
