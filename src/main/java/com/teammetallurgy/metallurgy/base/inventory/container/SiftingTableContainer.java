...
public class SiftingTableContainer extends Container {
    ...
    public boolean canInteractWith(PlayerEntity player) {
        return isWithinUsableDistance(IWorldPosCallable.of(Objects.requireNonNull(siftingTable.getWorld()), siftingTable.getPos()), player, MetallurgyBlock.SIFTING_TABLE);
    }
}
