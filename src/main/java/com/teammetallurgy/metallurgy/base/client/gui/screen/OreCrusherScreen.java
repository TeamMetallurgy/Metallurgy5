...
public class OreCrusherScreen extends ContainerScreen<OreCrusherContainer> {
    private static final ResourceLocation ORE_CRUSHER_GUI = new ResourceLocation(MetallurgyBase.MOD_ID, "textures/gui/container/ore_crusher.png");

    public OreCrusherScreen(OreCrusherContainer oreCrusherContainer, PlayerInventory playerInventory, ITextComponent title) {
        super(oreCrusherContainer, playerInventory, title);
        this.ySize = 172;
    }
