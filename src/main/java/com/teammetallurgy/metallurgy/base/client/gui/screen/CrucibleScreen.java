...
public class CrucibleScreen extends ContainerScreen<CrucibleContainer> {
    private static final ResourceLocation CRUCIBLE_GUI = new ResourceLocation(MetallurgyBase.MOD_ID, "textures/gui/container/crucible.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (this.minecraft != null) {
            this.minecraft.getTextureManager().bindTexture(CRUCIBLE_GUI);
        }
